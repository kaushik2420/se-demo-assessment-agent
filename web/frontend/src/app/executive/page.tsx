  ...
  return (
    <>
      ...
      <main className="max-w-7xl mx-auto p-10">
        <h1 className="text-2xl font-semibold mb-2">Executive summary — {data.month}</h1>
        <p className="text-slate-500 mb-6">{data.headline}</p>
        ...
        <Card title="AE quality risks">
          ...
          {data.ae_quality_risks.map((ae: any, i: number) => (
            <div key={i} className="p-4 bg-red-50 border border-red-200 rounded-lg mb-2">
              <div className="font-semibold text-red-900">{ae.ae_name} — {ae.interruption_count} interruptions</div>
